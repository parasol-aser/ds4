...
cpu: ds4_cli_cpu.o ds4_server_cpu.o ds4_bench_cpu.o ds4_eval_cpu.o ds4_agent_cpu.o ds4_help.o ds4_prompt_prefix.o ds4_web.o ds4_kvstore.o linenoise.o rax.o ds4_gpu_args_cpu.o $(CPU_CORE_OBJS)
...
# Classic matvec kernels for the mixed-recipe quant types against the
# generic path, on real tensors from a Qwen3.8 GGUF (Metal only).
DS4_QWEN_TEST_MODEL ?= gguf/Qwen3.8-27B-UD-Q4_K_M.gguf
tests/test_qwen_quant_mv.o: tests/test_qwen_quant_mv.c ds4_gpu.h ds4.h
	$(CC) $(CFLAGS) -I. -c -o $@ tests/test_qwen_quant_mv.c

tests/test_qwen_quant_mv: tests/test_qwen_quant_mv.o ds4_help.o ds4_prompt_prefix.o linenoise.o ds4_gpu_args.o $(CORE_OBJS)
	$(CC) $(CFLAGS) -o $@ $^ $(METAL_LDLIBS)

.PHONY: test-qwen-quant-mv
test-qwen-quant-mv: tests/test_qwen_quant_mv
	./tests/test_qwen_quant_mv $(DS4_QWEN_TEST_MODEL)
